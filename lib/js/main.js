window.addEventListener('DOMContentLoaded', function () {
  ...
  close.addEventListener('click', callModalWindow); //Form
  ...
  function sendForm(elem) {
    elem.addEventListener('submit', function (event) {
      ...
      postData(FormData).then(() => statusMessage.innerHTML = message.success).catch(() => statusMessage.innerHTML = message.failure).then(clearInput);
    });
  } // End sendForm


  sendForm(form); // Slider
